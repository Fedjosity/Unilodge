# Unilodge Realty - Next-Generation Real Estate Platform

A premium, cinematic landing page reimagining the Unilodge Realty brand. Built with the latest modern web technologies, this project emphasizes immersive user experience, smooth animations, and a high-end aesthetic suitable for a forward-thinking real estate company.
...
-   **Scroll-Triggered Animations**: Elements fade, slide, and scale as the user scrolls, powered by GSAP.
    -   *Bidirectional Animations*: Animations play on scroll down and reverse on scroll up for a responsive feel.
-   **Responsive Navbar**:
...
This project is proprietary and developed for Unilodge Realty.
